                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="circle-tile">
                                ...
                                <div class="circle-tile-content blue">
                                    ...
                                    <a href="{{ url('/entrevistas') }}" class="circle-tile-footer">Mais Informações <i class="fa fa-chevron-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="circle-tile">
                                ...
                                <div class="circle-tile-content purple">
                                    ...
                                    <a href="{{ url('/mencionados') }}" class="circle-tile-footer">Mais Informações <i class="fa fa-chevron-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
